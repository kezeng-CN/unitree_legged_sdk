...
/*
#cgo CFLAGS: -I./
#cgo LDFLAGS: -L./include -lunitree_legged_sdk_amd64 -lwrapper
...
func main() {
	fmt.Printf(`Communication level is set to HIGH-level. \n
	...
	loop_updSend := C.loop_udpSend()

	C.loop_udpSend_start(loop_updSend)
